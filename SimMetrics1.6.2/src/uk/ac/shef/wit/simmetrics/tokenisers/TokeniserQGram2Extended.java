 ...
 * TokeniserQGram2Extended implements a tokeniser splitting the string into
 * qGrams extending beyond the ends of the string input, using padding
 * characters.
 * 
 * Date: 25-Nov-2006 Time: 14:58:35
 * 
 * @author Sam Chapman <a href="http://www.dcs.shef.ac.uk/~sam/">Website</a>, <a
 *         href="mailto:sam@dcs.shef.ac.uk">Email</a>.
 * @version 1.1
 */
public final class TokeniserQGram2Extended implements InterfaceTokeniser,
		Serializable {
