...
public class TestSuite extends TestCase {
	...
	static public junit.framework.Test testAllTokenisers() {
		...
		newSuite.addTest(new TokeniserQGram2ExtendedTest(
				"testTokeniseToArrayList"));
		newSuite.addTest(new TokeniserQGram2Test("testTokeniseToArrayList"));
		newSuite.addTest(new TokeniserQGram3ExtendedTest(
				"testTokeniseToArrayList"));
		newSuite.addTest(new TokeniserQGram3Test("testTokeniseToArrayList"));
		newSuite
				.addTest(new TokeniserWhitespaceTest("testTokeniseToArrayList"));
		return newSuite;
	}
	...
	static public void main(String[] args) {
		...
		System.exit(TestRunner.run(runner.getTest(TestSuite.class.getName()))
				.wasSuccessful() ? 0 : 1);
	}
}
