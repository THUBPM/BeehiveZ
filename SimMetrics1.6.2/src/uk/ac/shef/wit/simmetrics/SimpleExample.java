...
/**
 * Package: uk.ac.shef.wit.simmetrics Description: SimpleExample implements a
 * simple example to demonstrate the ease to use a similarity metric. Date:
 * 19-Apr-2004 Time: 14:25:11
 * 
...
public class SimpleExample {
	...
	/**
	 * details the usage of the simple example outputing instructions to the
	 * standard output.
	 */
