...
/**
 * Package: uk.ac.shef.wit.simmetrics.similaritymetrics.qgrams Description:
 * uk.ac.shef.wit.simmetrics.similaritymetrics.qgrams implements a
 * 
 * Date: 05-Apr-2004 Time: 14:06:16
 * 
...
public final class QGramsDistance extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0.01 0.51 1.48 3.08 5.51 7.81 11.94 15.62 20.3 25.38 31.29 36.5 43.8
		// 50.75 62.5 67.67 78 88.67 93.67 117 125 133 148.5 172 171.5 204 218.5
		// 219 219 296 282 281 344 312 360 375 390 422 438 453 484 500 516 562
		// 563 594 625 656 656 703 719 766 765 813 828 875 891 937 953 985
	...
	public float getSimilarity(final String string1, final String string2) {
		...
		if (maxQGramsMatching == 0) {
			...
			return (maxQGramsMatching - getUnNormalisedSimilarity(string1,
					string2))
					/ (float) maxQGramsMatching;
		}
	}
