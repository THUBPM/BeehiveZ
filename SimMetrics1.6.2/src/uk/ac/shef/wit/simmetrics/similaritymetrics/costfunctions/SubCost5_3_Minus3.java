...
/**
 * Package: costfunctions Description: SubCost5_3_Minus3 implements a cost
 * function as used in Monge Elkan where by an exact match no match or an
 * approximate match whereby a set of characters are in an approximate range.
