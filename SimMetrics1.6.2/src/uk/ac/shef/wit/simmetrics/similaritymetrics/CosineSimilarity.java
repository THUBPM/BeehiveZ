 ...
 * Description: uk.ac.shef.wit.simmetrics.similaritymetrics.cosinesimilarity
 * implements a
 * 
...
public final class CosineSimilarity extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.02 0.03 0.05 0.08 0.11 0.14 0.18 0.23 0.27 0.33 0.39 0.46 0.52
		// 0.6 0.65 0.76 0.84 0.94 1.01 1.13 1.23 1.49 1.45 1.95 1.67 2.26 1.93
		// 2.6 2.26 2.86 2.54 3.17 2.91 3.76 3.17 3.9 3.5 4.32 3.9 5.1 4.32 5.64
		// 4.83 5.64 5.07 6.34 5.64 7.03 5.97 7.81 6.55 8.12 7 9.23 7.52 9.71
		// 8.12 10.68 8.46
