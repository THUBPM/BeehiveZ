 ...
 * Description: uk.ac.shef.wit.simmetrics.similaritymetrics.euclideandistance
 * implements a
 * 
 * Date: 05-Apr-2004 Time: 11:12:01
 * 
...
public final class EuclideanDistance extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.02 0.04 0.08 0.13 0.19 0.26 0.33 0.43 0.53 0.64 0.77 0.9 1.09
		// 1.27 1.39 1.57 1.83 1.93 2.27 2.42 2.82 2.9 3.56 3.44 4.32 3.9 5.51
		// 4.51 6.15 5.34 6.77 5.97 7.81 6.8 8.83 7.52 9.67 8.46 10.68 9.23
		// 11.94 10.2 13.53 11.28 14.5 11.94 15.62 13.53 16.92 14.57 16.92 15.62
		// 20.3 16.92 22.56 16.92 24.33 18.45 24.33
	 ...
	 * 
	 * the 0-1 return is calcualted from the maximum possible Euclidean distance
	 * between the strings from the number of terms within them.
	 * 
	 * @param string1
	 * @param string2
	...
	public float getSimilarity(final String string1, final String string2) {
		...
		float totalPossible = (float) Math.sqrt((str1Tokens.size() * str1Tokens
				.size())
				+ (str2Tokens.size() * str2Tokens.size()));
