 ...
 * Description: uk.ac.shef.wit.simmetrics.similaritymetrics.overlapcoefficient
 * implements a
 * 
 * Date: 05-Apr-2004 Time: 11:04:47
 * 
...
public final class OverlapCoefficient extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.01 0.03 0.05 0.07 0.11 0.14 0.18 0.23 0.27 0.33 0.38 0.46 0.51
		// 0.59 0.67 0.75 0.86 0.94 1.01 1.15 1.22 1.5 1.45 1.93 1.7 2.28 1.95
		// 2.42 2.21 2.99 2.54 3.34 2.86 3.76 3.17 4.06 3.5 4.32 3.9 5.23 4.32
		// 5.34 4.83 6.15 5.07 6.34 5.64 7.29 5.97 8.12 6.55 8.46 7 8.83 7.52
		// 9.71 8.12 10.68 8.46
	...
	public float getSimilarity(final String string1, final String string2) {
		...
		return (float) (commonTerms)
				/ (float) Math.min(termsInString1, termsInString2);
	}
