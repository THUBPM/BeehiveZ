...
/**
 * Package: uk.ac.shef.wit.simmetrics.api Description: AbstractStringMetric
 * implements a abstract class for the string metrics. Date: 24-Mar-2004 Time:
 * 12:07:10
 * 
...
public abstract class AbstractStringMetric implements InterfaceStringMetric {
	 ...
	 *         similarity measure
	 */
	public abstract float getSimilarityTimingEstimated(final String string1,
			final String string2);
	 ...
	 */
	public abstract float getUnNormalisedSimilarity(String string1,
			String string2);
}
