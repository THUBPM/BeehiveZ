...
/**
 * Package: uk.ac.shef.wit.simmetrics.similaritymetrics.jaro Description:
 * uk.ac.shef.wit.simmetrics.similaritymetrics.jaro implements the Jaro String
 * Metric.
 * 
 * Date: 01-Apr-2004 Time: 16:36:27
 * 
...
public final class Jaro extends AbstractStringMetric implements Serializable {
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.18 0.35 0.75 1.32 2.01 2.96 3.9 5.07 6.34 8.12 9.23 11.94 12.69
		// 15.69 16.92 20.3 22.56 27.38 27.25 40.8 33.83 40.6 40.6 54.75 46.8
		// 62.5 54.75 73 67.67 78 73 101.5 83.33 117 109.5 117.5 109 125 117.5
		// 140.5 148.5 132.5 156.5 148.5 172 164 179.5 187.5 203 211 203 203 250
