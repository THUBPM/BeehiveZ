...
/**
 * Description: ChapmanOrderedNameCompoundSimilarity tests similarity upon the
 * most similar in terms of token based names where the later names are valued
 * higher than earlier names. Surnames are less flexible than
 * 
 * @author Sam Chapman, NLP Group, Sheffield Uni, UK (<a
 *         href="mailto:sam@dcs.shef.ac.uk">email</a>, <a
...
public final class ChapmanOrderedNameCompoundSimilarity extends
	 ...
	 */
	public ChapmanOrderedNameCompoundSimilarity(
			final InterfaceTokeniser tokeniserToUse) {
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0.08 2.26 8.16 16.92 29 51 67.67 93.67 117 156.5 187.5 234 266 312
		// 375 422 485 547 609 656 766 828 906 1000 1078 1157 1265 1360 1453
		// 1562 1688 1781 1891 2031 2094 2219 2422 2532 2656 2812 2938 3109 3250
		// 3407 3562 3750 3907 4062 4250 4422 4625 4797 4985 5188 5390 5578 5782
		// 5984 6204 6437
	...
	/**
	 * gets the similarity of the two strings using a shifted weighting where
	 * the latter tokens compared are more important than earlier ones.
	 * 
	 * @param string1
	 * @param string2
