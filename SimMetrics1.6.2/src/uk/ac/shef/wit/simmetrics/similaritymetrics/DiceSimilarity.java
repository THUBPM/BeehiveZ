 ...
 * Description: uk.ac.shef.wit.simmetrics.similaritymetrics.dicesimilarity
 * implements a
 * 
 * Date: 05-Apr-2004 Time: 10:30:34
 * 
...
public final class DiceSimilarity extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.01 0.03 0.05 0.08 0.1 0.14 0.18 0.22 0.27 0.33 0.38 0.46 0.51 0.6
		// 0.65 0.76 0.83 0.93 1 1.1 1.21 1.31 1.44 1.54 1.65 1.78 1.92 2.06
		// 2.18 2.33 2.51 2.64 2.78 2.99 3.17 3.29 3.5 3.9 5.8 4.14 5.21 4.51
		// 5.8 4.86 6.55 5.34 7 5.8 7 6.34 8.16 6.77 9.23 7 9.67 7.52 10.15 8.46
		// 10.2
	...
	public float getSimilarity(final String string1, final String string2) {
		...
		// return Dices coefficient = (2*Common Terms) / (Number of terms in
		// String1 + Number of terms in String2)
