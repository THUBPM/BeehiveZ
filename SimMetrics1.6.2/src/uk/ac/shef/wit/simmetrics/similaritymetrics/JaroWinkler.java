...
/**
 * Package: uk.ac.shef.wit.simmetrics.similaritymetrics.jarowinkler Description:
 * uk.ac.shef.wit.simmetrics.similaritymetrics.jarowinkler implements a String
 * Metric.
 * 
...
public final class JaroWinkler extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.15 0.36 0.76 1.34 2.03 2.94 3.9 5.34 6.34 8.12 9.71 11.28 13.53
		// 15.62 16.92 20.3 22.56 25.38 33.57 31.29 33.83 40.6 40.6 54.75 50
		// 58.5 58.75 72.67 67.67 83.33 102 101.5 83.33 109 94 109 109.5 133 117
		// 125 133 132.5 141 148.5 156 156.5 171.5 203 250 235 219 218 250 219
		// 281 250 266 250 297
	...
	/**
	 * gets the similarity measure of the JaroWinkler metric for the given
	 * strings.
	 * 
	 * @param string1
	 * @param string2
