...
/**
 * Package: costfunctions Description: AbstractSubstitutionCost implements a
 * abstract class for substiution costs functions. Date: 24-Mar-2004 Time:
 * 13:34:45
 * 
...
public abstract class AbstractSubstitutionCost implements
	 ...
	 */
	public abstract float getCost(String str1, int string1Index, String str2,
			int string2Index);
