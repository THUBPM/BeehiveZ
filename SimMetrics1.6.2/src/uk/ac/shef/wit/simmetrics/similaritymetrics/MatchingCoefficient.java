 ...
 * @version 1.1
 */
public final class MatchingCoefficient extends AbstractStringMetric implements
		Serializable {
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.01 0.03 0.05 0.09 0.12 0.17 0.23 0.3 0.36 0.45 0.53 0.63 0.73
		// 0.85 0.95 1.1 1.21 1.4 1.49 1.69 1.83 2.16 2.18 2.74 2.54 3.46 2.94
		// 3.9 3.38 4.23 3.98 5.49 4.41 5.83 4.95 6.55 5.49 6.77 6.15 7.81 6.55
		// 9.27 7.52 9.23 8.12 11.28 8.83 11.94 9.71 11.94 10.15 12.69 11.28
		// 13.53 11.94 15.62 13.6 16.92 13.53
