 ...
 * Description: chapmanmeanlength implements a simple mean length metric, i.e.
 * strings of the similar lengths are more similar regardless of the content.
 * 
 * Date: 26-Mar-2004 Time: 14:15:54
 * 
...
public final class ChapmanMeanLength extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// return 0 as this similarity metric is near to zero milliseconds and
		// is independent
		return 0;
	}
	 ...
	 * 
	 * this is simply an average of the string lengths between those compared
	 * then scaled.
	 * 
	 * @param string1
	 * @param string2
	...
	public float getSimilarity(final String string1, final String string2) {
		...
		if (bothLengths > CHAPMANMEANLENGTHMAXSTRING) {
			...
			return 1.0f - (oneMinusBothScaled * oneMinusBothScaled
					* oneMinusBothScaled * oneMinusBothScaled);
		}
	}
