...
public final class Levenshtein extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.31 1.12 2.4 4.41 6.77 11.28 14.5 24.33 31.29 43.6 51 54.5 67.67
		// 68 78 88.67 101.5 109 117.5 140.5 148.5 156 180 187.5 219 203 250 250
		// 312 297 328 297 359 360 406 453 422 437 469 500 516 578 578 578 609
		// 672 656 688 766 765 781 829 843 875 891 984 954 984 1078
	 ...
	 * <p/>
	 * Copy character from string1 over to string2 (cost 0) Delete a character
	 * in string1 (cost 1) Insert a character in string2 (cost 1) Substitute one
