...
public final class BlockDistance extends AbstractStringMetric implements
	...
	public float getSimilarityTimingEstimated(final String string1,
		...
		// increment
		// 0 0.03 0.04 0.08 0.13 0.19 0.26 0.34 0.44 0.54 0.67 0.78 0.92 1.07
		// 1.24 1.38 1.6 1.77 2.01 2.15 2.39 2.64 2.86 3.12 3.38 3.69 4.08 4.72
		// 6.15 5.8 5.21 6.77 5.97 7.52 6.8 8.83 7.81 9.23 8.46 11.28 9.23 11.94
		// 10.2 13.53 11.28 13.53 12.69 15.62 13.53 16.92 14.57 18.45 15.62 20.3
		// 16.92 22.56 16.92 25.5 18.45 25.38
