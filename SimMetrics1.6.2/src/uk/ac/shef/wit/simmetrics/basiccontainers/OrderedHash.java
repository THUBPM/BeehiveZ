...
/**
 * Title: OrderedHash Description: class that implements an ordered hash
 * allowing keys and values to be linked in an ordered hash sequence.
 * 
...
final class OrderedHash extends Hashtable implements Serializable {
	 ...
	 * 
	 * @return vector of ordered vlaues (from the order in which they where
	 *         added)
	 */
