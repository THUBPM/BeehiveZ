...
/**
 * Package: uk.ac.shef.wit.simmetrics.api Description: InterfaceMetricArbitrator
 * provides an interface for a metric arbitrator. Date: 29-Apr-2004 Time:
 * 11:48:58
 * 
...
public interface InterfaceMetricArbitrator {
	...
	public void setArbitrationMetrics(
			ArrayList<InterfaceStringMetric> arbitrationMetrics);
     ...
     *
     */
	// todo add a method to update arbitration weightings or learn with input
	// here
