...
public final class FileLoader {
	 ...
	 * @param file
	 *            the file to open
	 * @return a string of the contents of the file or "" if empty or not
	 *         present
	 */
	 ...
	 * 
	 * @param f
	 *            a file for which to load its content
	 * @return a string containing the files contents or "" if empty or not
	 *         present
	 */
	 ...
	 * @param f
	 *            a file for which to load its content
	 * @return an Object containing the files contents or null if not present
	 */
	 ...
	 * 
	 * @param content
	 *            the object content to write
	 * @param fname
	 *            the filename to write it into
