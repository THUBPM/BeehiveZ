...
public class EnterOptionsPane extends JPanel {
	...
	// Components in panel
	private JTextField startStatesField, targetStatesField, stepField,
	...
	public EnterOptionsPane(boolean defaultStatus) {
		...
		errorField.setBorder(new TitledBorder(new EtchedBorder(),
				"Error Messages"));
		hadpne.chkbx.setSelected(defaultStatus);
		/*
		 * if(defaultStatus == true) //hadpne.numMapsField.setText("256"); else
