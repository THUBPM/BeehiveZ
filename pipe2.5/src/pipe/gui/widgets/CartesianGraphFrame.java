...
public class CartesianGraphFrame extends JFrame {
	...
	/**
	 * Creates the GraphPanel and initialises with xlist and ylist. Create the
	 * save button.
	 * 
	 * @param xlist
	 *            Data for x axis
	 ...
	 *            Data for y axis
	 */
	public void constructCartesianGraphFrame(ArrayList<Double> xlist,
			ArrayList<Double> ylist) {

		// this.setIconImage(new ImageIcon(CreateGui.imgPath +
		// "icon.png").getImage());
	 ...
	 * Seperated Variable file of format t value, probability, etc. Creates
	 * JFileChooser so user can select file name
	 */
