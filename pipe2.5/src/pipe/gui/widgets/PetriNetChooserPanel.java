...
public class PetriNetChooserPanel extends JPanel {
	...
	public PetriNetChooserPanel(String title, DataLayer _defaultNet) {
		...
		textField = new JTextField((defaultNet != null ? defaultNet.getURI()
				: null), 15);
		// textField.setMaximumSize(new
		// Dimension(Integer.MAX_VALUE,this.getPreferredSize().height));
		...
		this.setMaximumSize(new Dimension(Integer.MAX_VALUE, this
