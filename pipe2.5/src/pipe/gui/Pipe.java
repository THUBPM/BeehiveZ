...
public class Pipe {
	...
	/** X-Axis Scale Value */
	public static final int DISPLAY_SCALE_FACTORX = 7; // Scale factors for
	// loading other
	// Petri-Nets (not yet
	// implemented)
	/** Y-Axis Scale Value */
	public static final int DISPLAY_SCALE_FACTORY = 7; // Scale factors for
	// loading other
	// Petri-Nets (not yet
	// implemented)
	/** X-Axis Shift Value */
	public static final int DISPLAY_SHIFT_FACTORX = 270; // Scale factors for
	// loading other
	// Petri-Nets (not
	// yet implemented)
	/** Y-Axis Shift Value */
	public static final int DISPLAY_SHIFT_FACTORY = 120; // Scale factors for
	// loading other
	// Petri-Nets (not
	// yet implemented)
