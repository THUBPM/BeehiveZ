...
/**
 * Version of RGFileHeader implemented using the faster java.nio.* classes
 * 
...
public class NewRGFileHeader extends RGFileHeader {
	 ...
	 * @throws IOException
	 */
	public NewRGFileHeader(RandomAccessFile input)
	...
	/**
	 * writes the contents of the reachability graph header to a specified
	 * buffer
	 * 
	 * @param outputBuf
	 * @throws IOException
	...
	/**
	 * read in the contents of the reachabiliyt graph header from a specified
	 * buffer
	 * 
	 * @param inputBuf
	 * @throws IOException
	 * @throws IncorrectFileFormatException
	 */
	public void read(MappedByteBuffer inputBuf) throws IOException,
