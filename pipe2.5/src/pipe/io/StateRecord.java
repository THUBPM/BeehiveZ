 ...
 *         StateSpaceGenerator to save type of state - i.e. tangible or not.
 *         Also added new helper methods. This class is used to record states in
 *         a file.
 */
public class StateRecord {
	...
	public StateRecord(Marking newstate) {
		...
		System.arraycopy(newstate.getState(), 0, state, 0,
				newstate.getState().length);
	...
	public void read1(int statesize, RandomAccessFile ipfile)
			throws IOException {
