...
public class StateList {
	 ...
	 * 
	 * @param rgfile
	 *            - A reachability graph file containing a list of tangible
	 *            states.
	 * @throws IOException
	 * @throws StateSpaceTooBigException
	 * 
	 * @author Edwin Chung Mar 2007 - modified the constructor so it can allow
	 *         the reading of the type of state i.e. whether it is tangible or
	 *         not
	 */
	public StateList(File rgfile, boolean readTangible) throws IOException,
	...
	/**
	 * fastadd() The original add() methods carry out checks for duplicate
	 * entries. If the constructor StateList(RandomAccessFile rgfile) has been
	 * used, then this method can be called as the file should contain no
	 * duplicate entries. This makes the code more efficient and should execute
	 * faster as there could potentially be a few hundred thousand states.
	 * 
	 * @param m
	 *            The marking/state to be added
	 * @param id
	 *            An integer used to create an id for the marking
