...
/**
 * Exception called when a start/target state logical expression entered by the
 * user is syntactically incorrect, or doesn't correspond to an existing state
 * 
