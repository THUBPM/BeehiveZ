...
public class Place extends PlaceTransitionObject {
	...
	private static Shape proximityPlace = (new BasicStroke(
			Pipe.PLACE_TRANSITION_PROXIMITY_RADIUS)).createStrokedShape(place);
	...
	public UndoableEdit changeMarkingParameter(
			MarkingParameter _markingParameter) {
		MarkingParameter oldMarkingParameter = markingParameter;
		...
		currentMarking = markingParameter.getValue();
		update();
		return new ChangeMarkingParameterEdit(this, oldMarkingParameter,
				markingParameter);
	}
