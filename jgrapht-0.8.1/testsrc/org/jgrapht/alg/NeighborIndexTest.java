...
public class NeighborIndexTest extends TestCase {
	...
	public void testNeighborSet() {
		ListenableUndirectedGraph<String, DefaultEdge> g = new ListenableUndirectedGraph<String, DefaultEdge>(
				DefaultEdge.class);
		g.addVertex(V1);
		g.addVertex(V2);
	...
	public void testDirectedNeighborSet() {
		...
		DirectedNeighborIndex<String, DefaultEdge> index = new DirectedNeighborIndex<String, DefaultEdge>(
				g);
		g.addGraphListener(index);
