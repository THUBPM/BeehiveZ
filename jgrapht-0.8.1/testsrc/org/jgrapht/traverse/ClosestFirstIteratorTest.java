...
public class ClosestFirstIteratorTest extends AbstractGraphIteratorTest {
	...
	public void testRadius() {
		...
		AbstractGraphIterator<String, ?> iterator = new ClosestFirstIterator<String, DefaultEdge>(
				graph, "1", 301);
	...
	AbstractGraphIterator<String, DefaultEdge> createIterator(
		...
		AbstractGraphIterator<String, DefaultEdge> i = new ClosestFirstIterator<String, DefaultEdge>(
				g, vertex);
