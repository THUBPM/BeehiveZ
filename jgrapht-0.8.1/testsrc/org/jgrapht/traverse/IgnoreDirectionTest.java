 ...
 * Contributor(s):   -
 *
 * $Id: IgnoreDirectionTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 ...
 * 
 * <p>
 * NOTE: This test uses hard-coded expected ordering which isn't really
 * guaranteed by the specification of the algorithm. This could cause spurious
 * failures if the traversal implementation changes.
 * </p>
 * 
 * @author John V. Sichi
 * @since Aug 8, 2003
...
public class IgnoreDirectionTest extends AbstractGraphIteratorTest {
	...
	AbstractGraphIterator<String, DefaultEdge> createIterator(
		...
		UndirectedGraph<String, DefaultEdge> undirectedView = new AsUndirectedGraph<String, DefaultEdge>(
				g);
		AbstractGraphIterator<String, DefaultEdge> i = new DepthFirstIterator<String, DefaultEdge>(
				undirectedView, "4");
