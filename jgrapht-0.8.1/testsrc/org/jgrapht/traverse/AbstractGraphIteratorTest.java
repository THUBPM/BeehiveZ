...
public abstract class AbstractGraphIteratorTest extends EnhancedTestCase {
	...
	public void testDirectedGraph() {
		...
		AbstractGraphIterator<String, DefaultEdge> iterator = createIterator(
				graph, "1");
	...
	DirectedGraph<String, DefaultEdge> createDirectedGraph() {
		DirectedGraph<String, DefaultEdge> graph = new DefaultDirectedWeightedGraph<String, DefaultEdge>(
	 ...
	 * @author Barak Naveh
	 */
	private class MyTraversalListener implements
			TraversalListener<String, DefaultEdge> {
