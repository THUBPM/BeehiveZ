 ...
 *
 * $Id: BreadthFirstIteratorTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
...
public class BreadthFirstIteratorTest extends AbstractGraphIteratorTest {
	...
	AbstractGraphIterator<String, DefaultEdge> createIterator(
		...
		AbstractGraphIterator<String, DefaultEdge> i = new BreadthFirstIterator<String, DefaultEdge>(
				g, vertex);
