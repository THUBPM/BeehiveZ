...
public class SimpleDirectedGraphTest extends EnhancedTestCase {
	...
	public void testReversedView() {
		...
		DirectedGraph<String, DefaultEdge> g = new SimpleDirectedGraph<String, DefaultEdge>(
				DefaultEdge.class);
		DirectedGraph<String, DefaultEdge> r = new EdgeReversedGraph<String, DefaultEdge>(
				g);
	...
	private void verifyReversal(DirectedGraph<String, DefaultEdge> g,
			DirectedGraph<String, DefaultEdge> r, DefaultEdge e) {
	...
	private void init() {
		gEmpty = new SimpleDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
		g1 = new SimpleDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
		g2 = new SimpleDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
		g3 = new SimpleDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
		g4 = new SimpleDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
