...
public class AsWeightedGraphTest extends EnhancedTestCase {
	...
	public void setUp() {
		weightedGraph = new SimpleWeightedGraph<String, DefaultWeightedEdge>(
				DefaultWeightedEdge.class);
		unweightedGraph = new SimpleGraph<String, DefaultEdge>(
				DefaultEdge.class);
	...
	public void test1() {
		...
		assertEquals(unweightedGraph.getEdgeWeight(e1),
				WeightedGraph.DEFAULT_EDGE_WEIGHT);

		WeightedGraph<String, DefaultEdge> g1 = new AsWeightedGraph<String, DefaultEdge>(
				unweightedGraph, weightMap1);
		WeightedGraph<String, DefaultWeightedEdge> g2 = new AsWeightedGraph<String, DefaultWeightedEdge>(
				weightedGraph, weightMap2);
		...
		assertEquals(unweightedGraph.getEdgeWeight(e2),
				WeightedGraph.DEFAULT_EDGE_WEIGHT);
