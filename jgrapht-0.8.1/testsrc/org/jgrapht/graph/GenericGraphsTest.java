 ...
 *
 * $Id: GenericGraphsTest.java 692 2009-07-04 06:50:26Z perfecthash $
 *
 * Changes
 * -------
...
public class GenericGraphsTest extends EnhancedTestCase {
	...
	public void testAlissaHacker() {
		DirectedGraph<String, CustomEdge> g = new DefaultDirectedGraph<String, CustomEdge>(
				CustomEdge.class);
		g.addVertex("a");
		g.addVertex("b");
		g.addEdge("a", "b");
	...
	public static class EquivGraph extends
			AbstractBaseGraph<EquivVertex, DefaultEdge> implements
			UndirectedGraph<EquivVertex, DefaultEdge> {
		/**
         * 
         */
		...
		public EquivGraph() {
			super(new ClassBasedEdgeFactory<EquivVertex, DefaultEdge>(
