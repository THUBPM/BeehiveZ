...
public class EquivalenceGroupCreatorTest extends TestCase {
	 ...
	 * groups , which are infact mod6 , examples: <li>mod2 = 0 , mod3 = 0 -->
	 * mod6=0 , like : 6 , 12 <li>mod2 = 1 , mod3 = 0 --> mod6=1 , like : 7 , 13
	 * <li>
	 */
	public void testComparatorChain() {
		EquivalenceComparatorChain<Integer, Object> comparatorChain = new EquivalenceComparatorChainBase<Integer, Object>(
		...
		testOneComparator(comparatorChain, 6);
	}

	@SuppressWarnings("unchecked")
	public void testComparatorChainSameComparatorTwice() {
		EquivalenceComparatorChain comparatorChain = new EquivalenceComparatorChainBase(
				new OddEvenGroupComparator());
		...
		testOneComparator(comparatorChain, 2);
	}

	@SuppressWarnings("unchecked")
	private void testOneComparator(EquivalenceComparator comparator,
		...
		EquivalenceSet[] eqGroupArray = EquivalenceSetCreator
				.createEqualityGroupOrderedArray(integerArray, comparator, null);
